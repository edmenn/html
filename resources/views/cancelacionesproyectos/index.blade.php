        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('cancelacionesproyectos.create', $proyecto->id) }}" class="btn btn-primary">Agregar Cancelación de Monto</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tbody><tr>
                                        <td><a href="{{ route('cancelacionesproyectos.edit', [$proyecto->id, $item->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> </a></td>
        ...
        try {
            ...
            .then((data) => {
                if(data.status == "success"){
                    location.href = "{{ route('cancelacionesproyectos.index', $proyecto->id) }}";
