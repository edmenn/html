    ...
    <section class="content">
        <div class="box box-60">
            <div class="box-header">
                <h3 class="box-title display-block text-center">EDITAR LOCALIDAD</h3>
            </div>
            <div class="box-body">

                <form class="form-horizontal" action="{{ route('localidades.update', $localidad->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body card-padding">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="nombre" name="nombre" type="text" class="form-control" value="{{ old('nombre', $localidad->nombre) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="direccion" name="direccion" type="text" class="form-control" value="{{ old('direccion', $localidad->direccion) }}" />
