    ...
    <section class="content">
        <div class="box box-60">
            <div class="box-header">
                <h3 class="box-title display-block text-center">EDITAR PROVEEDOR</h3>
            </div>
            <div class="box-body">

                <form class="form-horizontal" action="{{ route('proveedores.update', $proveedor->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body card-padding">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="nombre_fantasia" name="nombre_fantasia" type="text" class="form-control" value="{{ old('nombre_fantasia', $proveedor->nombre_fantasia) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="razon_social" name="razon_social" type="text" class="form-control" value="{{ old('razon_social', $proveedor->razon_social) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="ruc" name="ruc" type="text" class="form-control" value="{{ old('ruc', $proveedor->ruc) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="telefono" name="telefono" type="text" class="form-control" value="{{ old('telefono', $proveedor->telefono) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="direccion" name="direccion" type="text" class="form-control" value="{{ old('direccion', $proveedor->direccion) }}" />
