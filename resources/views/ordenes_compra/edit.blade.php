    ...
    <section class="content">
        <div class="box box-60">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('ordenes_compra.update', $orden_compra->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body card-padding">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="concepto" name="concepto" type="text" class="form-control" value="{{ old('concepto', $orden_compra->concepto) }}" />
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <select id="proveedor_id" name="proveedor_id" class="form-control">
                                    @foreach ($proveedores as $item)
                                        <option value="{{ $item->id }}" @if($item->id==old('proveedor_id', $orden_compra->proveedor_id)) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" id="fecha_factura" name="fecha_factura" class="form-control" placeholder="dd/mm/yyyy (Ejemplo 27/05/2022)" value="{{ old('fecha_factura', date('d/m/Y', strtotime($orden_compra->fecha_factura))) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" id="numero_factura" name="numero_factura" class="form-control" value="{{ old('numero_factura', $orden_compra->numero_factura) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="number" id="monto" name="monto" class="form-control" value="{{ old('monto', $orden_compra->monto) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="number" id="iva" name="iva" class="form-control" value="{{ old('iva', $orden_compra->iva) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="number" id="monto_iva" name="monto_iva" class="form-control" value="{{ old('monto_iva', $orden_compra->monto_iva) }}" />
