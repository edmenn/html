        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-body">
                        <form id="form" class="form-horizontal" action="{{ route('reportes.presupuesto') }}" method="GET">
                            @csrf
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                <b>Contratado: </b>{{ 'Gs. '.number_format($proyecto->contratado,0,',','.') }}
                            </p>
                            <ul>
                            @foreach ($proyecto->subproyectos as $subproyecto)
                                ...
                                <p>
                                    ...
                                    <b>Contratado: </b>{{ 'Gs. '.number_format($subproyecto->contratado,0,',','.') }}
                                </p>
                            @endforeach
                            </ul>
                            <hr />
