    ...
    <section class="content">
        <div class="box box-60">
            <div class="box-header">
                <h3 class="box-title display-block text-center">EDITAR ESTADO DEL PROYECTO</h3>
            </div>
            <div class="box-body">

                <form class="form-horizontal" action="{{ route('presupuestos.proyectos.update-estado', [$presupuesto->id, $proyecto->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body card-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <textarea class="form-control" readonly>{{ $proyecto->descripcion }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" class="form-control" value="{{ $proyecto->anho_fiscal }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" class="form-control" value="{{ $proyecto->codigo }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" class="form-control" value="{{ $proyecto->user->nombre.' '.$proyecto->user->apellido }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" class="form-control" value="{{ $proyecto->costo }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input type="text" class="form-control" value="{{ $proyecto->contratado }}" readonly />
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <select id="estado_id" name="estado_id" class="form-control">
                                    @foreach ($estados as $item)
                                        <option value="{{ $item->id }}" @if($item->id==old('estado_id', $proyecto->estado_id)) selected @endif>
                                            {{ $item->nombre }}
                                        </option>
                                    @endforeach
                                </select>
