        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('proyectos.documentos.create', $proyecto->id) }}" class="btn btn-primary">Agregar documento</a>
                </div>
            </div>
        ...
        try {
            ...
            .then((data) => {
                if(data.status == "success"){
                    location.href = "{{ route('proyectos.documentos.index', $proyecto->id) }}";
