    ...
    <section class="content">
        <div class="box box-60">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('proyectos.licitaciones.update', [$proyecto->id, $licitacion->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body card-padding">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <select id="proveedor_id" name="proveedor_id" class="form-control">
                                    @foreach ($proveedores as $item)
                                        <option value="{{ $item->id }}" @if($item->id==old('proveedor_id', $licitacion->proveedor_id)) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="concepto" name="concepto" type="text" class="form-control" value="{{ old('concepto', $licitacion->concepto) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="monto" name="monto" type="number" class="form-control" value="{{ old('monto', $licitacion->monto) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <textarea id="comentarios" name="comentarios" class="form-control">{{ old('comentarios', $licitacion->comentarios) }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ route('proyectos.licitaciones.index', $proyecto->id) }}" class="btn btn-default m-l-5">Cancelar</a>
                            </div>
                        </div>
