        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('proyectos.cancelaciones.create', $proyecto->id) }}" class="btn btn-primary">Agregar Cancelación de Monto</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tbody><tr>
                                        <td><a href="{{ route('proyectos.cancelaciones.edit', [$proyecto->id, $item->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> </a></td>
...
function eliminateHandle(id){
    ...
    if (confirm(text) == true) {
        try {
            ...
            fetch("/cancelacionesproyectos/{{ $proyecto->id }}/"+id, 
            ...
            .then((data) => {
                if(data.status == "success"){
                    location.href = "{{ route('proyectos.cancelaciones.index', $proyecto->id) }}";
