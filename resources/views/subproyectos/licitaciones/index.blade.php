    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Licitaciones del Subproyecto <a href="{{ route('proyectos.subproyectos.index', $subproyecto->proyecto_id) }}">{{ $subproyecto->nombre }}</a></h3>
                </div>
                <div class="pull-right">
                    <a href="{{ route('subproyectos.licitaciones.create', $subproyecto->id) }}" class="btn btn-primary">Agregar licitación</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td><a href="{{ route('subproyectos.licitaciones.edit', [$subproyecto->id, $item->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> </a></td>
...
function eliminateHandle(id){
    ...
    if (confirm(text) == true) {
        try {
            ...
            fetch("/licitacionessubproyectos/{{ $subproyecto->id }}/"+id, 
            ...
            .then((data) => {
                if(data.status == "success"){
                    location.href = "{{ route('subproyectos.licitaciones.index', $subproyecto->id) }}";
