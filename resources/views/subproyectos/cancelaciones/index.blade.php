        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('subproyectos.cancelaciones.create', $subproyecto->id) }}" class="btn btn-primary">Agregar Cancelación de Monto</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tbody><tr>
                                        <td><a href="{{ route('subproyectos.cancelaciones.edit', [$subproyecto->id, $item->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> </a></td>
        ...
        try {
            ...
            .then((data) => {
                if(data.status == "success"){
                    location.href = "{{ route('subproyectos.cancelaciones.index', $subproyecto->id) }}";
