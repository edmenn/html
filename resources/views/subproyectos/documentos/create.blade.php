    ...
    <section class="content">
        <div class="box box-60">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('subproyectos.documentos.store', $subproyecto->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ route('subproyectos.documentos.index', $subproyecto->id) }}" class="btn btn-default m-l-5">Cancelar</a>
                            </div>
                        </div>
