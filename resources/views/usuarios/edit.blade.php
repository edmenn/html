    ...
    <section class="content">
        <div class="box box-60">
            <div class="box-header">
                <h3 class="box-title display-block text-center">EDITAR USUARIO</h3>
            </div>
            <div class="box-body">
                    ...
                    <div class="card-body card-padding">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="nombre" name="nombre" type="text" class="form-control" value="{{ old('nombre', $user->nombre) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="apellido" name="apellido" type="text" class="form-control" value="{{ old('apellido', $user->apellido) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <input id="cedula" name="cedula" type="text" class="form-control" value="{{ old('cedula', $user->cedula) }}" />
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <select id="rol_id" name="rol_id" class="form-control">
                                    @foreach ($roles as $item)
                                        <option value="{{ $item->id }}" @if($item->id==old('rol_id', $user->rol_id)) selected @endif>
                                            {{ $item->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10 col-xs-6">
                                <select id="departamento_id" name="departamento_id" class="form-control">
                                    @foreach ($departamentos as $item)
                                        <option value="{{ $item->id }}" @if($item->id==old('departamento_id', $user->departamento_id)) selected @endif>
                                            {{ $item->nombre }}
                                        </option>
                                    @endforeach
                                </select>
